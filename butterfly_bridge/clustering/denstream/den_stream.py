# this code is for Denstream, but it has problems....we use it to save time...
...
from .typing import FloatArrayType, InputDict, IntArrayType, MetricsDict
...
class DenStream:
    ...
    def _merging(self, current_time: int, feature_array: FloatArrayType, label: Optional[int] = None):
        """
    ...
    def partial_fit(
        ...
        cluster, is_outlier = self._merging(time, feature_array, label)
    ...
    def _cluster_evaluate(self, iteration: int) -> None:
        ...
        predicted_labels = self.request_clustering()
    ...
    def request_clustering(self) -> IntArrayType:
        """
        ...
        cluster_labels: IntArrayType = local_model.fit_predict(center_array)
